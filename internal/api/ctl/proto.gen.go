// forester-controller v0.0.1 22fdfbcfdeb69c82a67f0a5a7b9b352988cf60fb
// --
...
func WebRPCSchemaHash() string {
	return "22fdfbcfdeb69c82a67f0a5a7b9b352988cf60fb"
}
...
type SystemService interface {
	...
	Acquire(ctx context.Context, systemPattern string, imagePattern string, comment string, snippets []string, customSnippet string, force bool) error
...
func (s *systemServiceServer) serveAcquireJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.SystemService.Acquire(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4, reqPayload.Arg5)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *systemServiceClient) Acquire(ctx context.Context, systemPattern string, imagePattern string, comment string, snippets []string, customSnippet string, force bool) error {
	in := struct {
		Arg0 string   `json:"systemPattern"`
		Arg1 string   `json:"imagePattern"`
		Arg2 string   `json:"comment"`
		...
		Arg4 string   `json:"customSnippet"`
		Arg5 bool     `json:"force"`
	}{systemPattern, imagePattern, comment, snippets, customSnippet, force}
	err := doJSONRequest(ctx, c.client, c.urls[3], in, nil)
	return err
}
