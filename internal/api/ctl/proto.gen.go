// forester-controller v0.0.1 6ea9c5d5514e887a5c65c67e86d1b4b03a2e215d
// --
...
func WebRPCSchemaHash() string {
	return "6ea9c5d5514e887a5c65c67e86d1b4b03a2e215d"
}
...
type SystemService interface {
	...
	Acquire(ctx context.Context, systemPattern string, imagePattern string, comment string, snippets []string, customSnippet string) error
...
func (s *systemServiceServer) serveAcquireJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.SystemService.Acquire(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *systemServiceClient) Acquire(ctx context.Context, systemPattern string, imagePattern string, comment string, snippets []string, customSnippet string) error {
	in := struct {
		Arg0 string   `json:"systemPattern"`
		Arg1 string   `json:"imagePattern"`
		Arg2 string   `json:"comment"`
		Arg3 []string `json:"snippets"`
		Arg4 string   `json:"customSnippet"`
	}{systemPattern, imagePattern, comment, snippets, customSnippet}
	err := doJSONRequest(ctx, c.client, c.urls[3], in, nil)
	return err
}
