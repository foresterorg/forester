// forester-controller v0.0.1 7ff445fb8d1eda15b4c34d0557d60e2cac91f397
// --
...
func WebRPCSchemaHash() string {
	return "7ff445fb8d1eda15b4c34d0557d60e2cac91f397"
}
...
type SystemService interface {
	...
	Acquire(ctx context.Context, system *SystemToAcquire) (time.Time, error)
...
func (s *systemServiceServer) serveAcquireJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqContent := struct {
		Arg0 *SystemToAcquire `json:"system"`
	}{}
	...
	func() {
		...
		ret0, err = s.SystemService.Acquire(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 time.Time `json:"acquired_at"`
	}{ret0}
...
func (c *systemServiceClient) Acquire(ctx context.Context, system *SystemToAcquire) (time.Time, error) {
	in := struct {
		Arg0 *SystemToAcquire `json:"system"`
	}{system}
	out := struct {
...
func (c *systemServiceClient) Release(ctx context.Context, systemId int64) error {
	in := struct {
		Arg0 int64 `json:"systemId"`
	}{systemId}
