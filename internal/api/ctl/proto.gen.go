// forester-controller v0.0.1 4ea191e54cde2b8fff553d71778e6eabba6780de
// --
...
func WebRPCSchemaHash() string {
	return "4ea191e54cde2b8fff553d71778e6eabba6780de"
}
...
type SystemService interface {
	...
	Acquire(ctx context.Context, systemPattern string, imagePattern string, force bool, snippets []string, customSnippet string, ksOverride string, comment string) error
...
func (s *systemServiceServer) serveAcquireJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.SystemService.Acquire(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4, reqPayload.Arg5, reqPayload.Arg6)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *systemServiceClient) Acquire(ctx context.Context, systemPattern string, imagePattern string, force bool, snippets []string, customSnippet string, ksOverride string, comment string) error {
	in := struct {
		Arg0 string   `json:"systemPattern"`
		Arg1 string   `json:"imagePattern"`
		Arg2 bool     `json:"force"`
		...
		Arg5 string   `json:"ksOverride"`
		Arg6 string   `json:"comment"`
	}{systemPattern, imagePattern, force, snippets, customSnippet, ksOverride, comment}
	err := doJSONRequest(ctx, c.client, c.urls[3], in, nil)
	return err
}
