// forester-controller v0.0.1 41cfec5be441b6ad9b75785297a5ee94d72d1380
// --
...
func WebRPCSchemaHash() string {
	return "41cfec5be441b6ad9b75785297a5ee94d72d1380"
}
...
type ApplianceService interface {
	...
	Enlist(ctx context.Context, applianceID int64, namePattern string) error
	Delete(ctx context.Context, applianceID int64) error
}
...
type SystemService interface {
	...
	Reset(ctx context.Context, systemID int64) error
}
...
func (c *applianceServiceClient) Enlist(ctx context.Context, applianceID int64, namePattern string) error {
	in := struct {
		Arg0 int64  `json:"applianceID"`
		Arg1 string `json:"namePattern"`
	}{applianceID, namePattern}

	err := doJSONRequest(ctx, c.client, c.urls[2], in, nil)
	return err
}

func (c *applianceServiceClient) Delete(ctx context.Context, applianceID int64) error {
	in := struct {
		Arg0 int64 `json:"applianceID"`
	}{applianceID}
...
func (c *systemServiceClient) Reset(ctx context.Context, systemID int64) error {
	in := struct {
		Arg0 int64 `json:"systemID"`
	}{systemID}
