// forester-controller v0.0.1 a8742b66bbd2857b7c1f40a8322fc74253cf2613
// --
...
func WebRPCSchemaHash() string {
	return "a8742b66bbd2857b7c1f40a8322fc74253cf2613"
}
...
type SystemService interface {
	...
	Acquire(ctx context.Context, systemPattern string, imagePattern string, comment string, snippets []string) error
...
func (s *systemServiceServer) serveAcquireJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.SystemService.Acquire(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *systemServiceClient) Acquire(ctx context.Context, systemPattern string, imagePattern string, comment string, snippets []string) error {
	in := struct {
		Arg0 string   `json:"systemPattern"`
		Arg1 string   `json:"imagePattern"`
		Arg2 string   `json:"comment"`
		Arg3 []string `json:"snippets"`
	}{systemPattern, imagePattern, comment, snippets}
